...
export const constantRoutes = [
  ...
  {
    path: '/auth/home',
    component: () => import('@/public/auth/index'),
    hidden: true,
    meta: {requiresAuth: false}
  },
  {
    path: '/public/common/video',
    component: () => import('@/public/common/SpecialVideo'),
    hidden: true,
    meta: {requiresAuth: false}
  },
  {
    path: '/public/common/sound-switch',
    component: () => import('@/public/common/SoundSwitch'),
    hidden: true,
    meta: {requiresAuth: false}
  },
  {
    path: '/public/common/special-img',
    component: () => import('@/public/common/SpecialImg'),
    hidden: true,
    meta: {requiresAuth: false}
  },
  {
